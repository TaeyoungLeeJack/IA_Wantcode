...
\title{Computer Science Internal Accessment} % Title of the book

\author{Taeyoung Lee} % Author

\publisher{Taeyoung Lee} % Publisher
...
& \multicolumn{6}{c}{Record of the tasks} \\ % Amalgamating several columns into one cell is done using the \multicolumn command as seen on this line
...
Strain & Beginning Date &Action & Details & Comments & Date Completed & Criterion\\ % Column names row
\midrule % In-table horizontal line
GDS1002 & 0.962 & 0.821 & 0.356 & 0.682 & 0.801&0\\ % Content row 1
NWN652 & 0.981 & 0.891 & 0.527 & 0.574 & 0.984&0\\ % Content row 2
PPD234 & 0.915 & 0.936 & 0.491 & 0.276 & 0.965&0\\ % Content row 3
JSB126 & 0.828 & 0.827 & 0.528 & 0.518 & 0.926&0\\ % Content row 4
JSB724 & 0.916 & 0.933 & 0.482 & 0.644 & 0.937&0\\ % Content row 5
\midrule % In-table horizontal line
\midrule % In-table horizontal line
Average Rate & 0.920 & 0.882 & 0.477 & 0.539 & 0.923&0\\ % Summary/total row
...
\subsection{Prototype of Solution}
...
\section{Record of the tasks}
*******Upper table in introduction section
...
\chapter{Fucntionality and extensibility of product}
\label{ch:4}
